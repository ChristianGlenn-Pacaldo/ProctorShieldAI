    ...
    <div className="animate-fade-in grid lg:grid-cols-2 gap-4">
      ...
      <div className="bg-[var(--surface)] rounded-2xl border border-[var(--border)]">
        ...
        <div className="p-8 text-center">
          ...
          <h3 className="text-lg font-bold text-[var(--ink)] mb-1">Juan Dela Cruz</h3>
      ...
      <div className="bg-[var(--surface)] rounded-2xl border border-[var(--border)]">
        ...
        <div className="p-5 space-y-4">
          <div>
            ...
            <input defaultValue="Juan Dela Cruz" className="w-full px-4 py-2.5 rounded-xl bg-[var(--surface2)] border border-[var(--border)] text-sm text-[var(--ink)] focus:outline-none focus:border-indigo-500/50" />
          </div>
          <div>
            <label className="text-xs font-semibold text-[var(--muted)] mb-1.5 block">Email Address</label>
            <input defaultValue="student@demo.com" disabled className="w-full px-4 py-2.5 rounded-xl bg-[var(--surface2)] border border-[var(--border)] text-sm text-[var(--muted)] cursor-not-allowed" />
          </div>
